...
public class Map implements Serializable {
    ...
    public void init() {
        ...
        kitchen.setRow(1);
        kitchen.setColumn(8);
        kitchen.setLocationType(LocationType.Kitchen);
        ...
        dungeon.setRow(3);
        dungeon.setColumn(8);
        dungeon.setLocationType(LocationType.Dungeon);
        ...
        gallows.setRow(1);
        gallows.setColumn(7);
        gallows.setLocationType(LocationType.Gallows);
        ...
        //setup westlandWoods
        westlandWoods.setRow(1);
        westlandWoods.setColumn(5);
        ...
        enchantedGarden.setRow(4);
        enchantedGarden.setColumn(5);
        ...
        deepWestlandWoods.setRow(1);
        deepWestlandWoods.setColumn(4);
